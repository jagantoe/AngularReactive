...
@Component({
  ...
  template: `
    <div class="relative">
      ...
      <div class="peer-focus:block hidden absolute z-50 w-full mt-1 bg-white rounded-lg shadow-lg border border-gray-200 max-h-60 overflow-y-auto" (click)="selectPokemon(0)">
